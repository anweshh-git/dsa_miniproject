...
void MapView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->routeRequested((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MapView::*)(int )>(_a, &MapView::buildingClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MapView::*)(int , int )>(_a, &MapView::routeRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void MapView::buildingClicked(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void MapView::routeRequested(int _t1, int _t2)
{
